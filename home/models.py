...
class Quotation(models.Model): 
    ...
    require_documents = models.ManyToManyField(QuotationDocType, verbose_name='Document needed for test',help_text="Help Text will go", related_name='requiredocuments')
